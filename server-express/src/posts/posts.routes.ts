...
postsRouter.get('/v1.1/id/:postId', () =>
  asyncWrap(PostsController.getByPostId),
);

postsRouter.get('/v1.2/id/:postId', () =>
  asyncWrap(PostsControllerV1_2.getByPostId),
);
...
postsRouter.get('/v1.1/author/:postId', () =>
  asyncWrap(PostsController.getAuthorByPostId),
);

postsRouter.get('/v1.1/:authorId/:page', SharedMiddleWare.validatePage, () =>
  asyncWrap(PostsController.getPostsByAuthorAndPage),
);

postsRouter.get('/v1.1/:page', SharedMiddleWare.validatePage, () =>
...
postsRouter.get('/v1.2/author/:postId', () =>
  asyncWrap(PostsControllerV1_2.getAuthorByPostId),
);

postsRouter.get('/v1.2/:authorId/:page', SharedMiddleWare.validatePage, () =>
  asyncWrap(PostsControllerV1_2.getPostsByAuthorAndPage),
);

postsRouter.get('/v1.2/:page', SharedMiddleWare.validatePage, () =>
